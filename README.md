...
Reproduction and extension of the [ThaiOCRBench paper](https://arxiv.org/abs/2511.04479) (Nonesung et al., 2025). We re-run the benchmark on GPT-4o and extend it to gemini-3-pro-preview, gemini-3-flash-preview, gpt-5.2, gpt-5-mini, iapp-ocr, typhoon-ocr, claude-opus-4-6, and claude-haiku-4-5. This was done in February 25, 2026.
...
| iapp-ocr | .183 | .933 | .321 | .695 | .267 | .367 | .697 | .467 | .491 | — |
...
Pre-computed results are included in the `results/` directory. The runner will skip any samples that already have results, so you can use them as-is or delete them to re-run from scratch:

```bash
# Use existing results (just prints summary)
npx tsx index.ts gpt-4o --small

# Re-run from scratch
rm results/gpt-4o-small.json
npx tsx index.ts gpt-4o --small
```
...
2. We ran the benchmark in the same way the authors of the paper did but for `gemini-3-pro-preview`, `gemini-3-flash-preview`, `gpt-5.2`, `gpt-5-mini`, `iapp-ocr`, `typhoon-ocr`, `claude-opus-4-6`, and `claude-haiku-4-5` as of Feb 25, 2026.
...
| Task | Metric | Paper GPT-4o | gemini-3-pro | gemini-3-flash | gpt-5.2 | gpt-5-mini | claude-opus-4-6 | gpt-4o | iapp-ocr | typhoon-ocr | claude-haiku-4-5 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Fine-grained text recognition | BMFL | 0.259 | **0.614** | 0.499 | 0.229 | 0.324 | 0.290 | 0.259 | 0.183 | 0.131 | 0.099 |
| Full-page OCR | BMFL | 0.637 | 0.976 | **0.978** | 0.899 | 0.848 | 0.949 | 0.715 | 0.933 | 0.881 | 0.474 |
| Handwritten content extraction | BMFL | 0.414 | 0.820 | **0.856** | 0.564 | 0.545 | 0.626 | 0.418 | 0.321 | 0.331 | 0.195 |
| Text recognition | ANLS | 0.729 | 0.903 | **0.914** | 0.749 | 0.765 | 0.608 | 0.732 | 0.695 | 0.572 | 0.476 |
| Document classification | ANLS | 0.987 | 0.967 | 0.967 | 0.900 | 0.967 | 0.967 | **0.987** | 0.267 | 0.267 | 0.855 |
| Diagram VQA | ANLS | 0.509 | 0.595 | **0.607** | 0.504 | 0.535 | 0.513 | 0.479 | 0.367 | 0.400 | 0.204 |
| Cognition VQA | ANLS | 0.717 | 0.829 | **0.872** | 0.816 | 0.764 | 0.674 | 0.724 | 0.697 | 0.500 | 0.526 |
| Infographics | ANLS | 0.692 | **0.814** | 0.810 | 0.813 | 0.803 | 0.678 | 0.665 | 0.467 | 0.533 | 0.417 |
| **Overall Average** | | **0.618** | **0.815** | **0.813** | **0.684** | **0.694** | **0.663** | **0.626** | **0.491** | **0.452** | **0.406** |
